...
{    
    ...
    public static float SetCartSpeed(User user, WorldObject vehicle)
    {
        switch (vehicle)
        {
            case WheelbarrowObject: return GetCartSpeedMultiplier(user)   *  2.0f;
            ...
            default: return GetCartSpeedMultiplier(user)                  *  1.0f;
        }
    }
}
namespace Eco.Mods.TechTree
{
    public partial class WheelbarrowObject
    {
        ...
        {
            GetComponent<VehicleComponent>().Initialize(CartSpeed.SetCartSpeed(this.Creator, this), 1, 1);
        }
    }
